    ...
    <MainLayout>
      {isDemoMode ? (
        ...
        <div className="bg-light py-8">
          ...
          <UniversalFaqSection 
            title="Часто задаваемые вопросы о трансферах"
            subtitle="ТРАНСФЕРЫ НА ПХУКЕТЕ"
            description="Ответы на популярные вопросы о трансферах из аэропорта и между отелями"
            faqItems={[
              {
                id: 1,
                question: 'Где меня встретят в аэропорту?',
                answer: 'Наш водитель встретит вас в зале прилета с табличкой с вашим именем. После получения багажа просто ищите нашего представителя возле выхода из зоны получения багажа.',
                isPopular: true,
                color: 'primary'
              },
              {
                ...
                answer: 'Мы отслеживаем статус рейсов в режиме реального времени. Водитель будет ждать вас независимо от задержки рейса без дополнительной платы.',
                color: 'primary'
              },
              {
                id: 3,
                question: 'Можно ли остановиться по дороге в магазине?',
                answer: 'Да, можно сделать одну остановку в супермаркете или магазине по дороге без дополнительной платы. Время ожидания до 15 минут.',
                color: 'primary'
              },
              {
                id: 4,
                question: 'Включена ли детская автокресло?',
                answer: 'Детские автокресла предоставляются бесплатно по запросу. Обязательно укажите возраст ребенка при бронировании.',
                isNew: true,
                color: 'primary'
              },
              {
                id: 5,
                question: 'Как оплатить трансфер?',
                answer: 'Оплата возможна онлайн при бронировании картой или наличными водителю в автомобиле. Принимаем тайские баты, доллары США и евро.',
                color: 'primary'
              },
              {
                id: 6,
                question: 'Можно ли отменить или изменить бронирование?',
                answer: 'Бесплатная отмена или изменение возможны за 24 часа до поездки. При отмене менее чем за 24 часа взимается штраф 50% стоимости.',
                color: 'primary'
              }
            ]}
