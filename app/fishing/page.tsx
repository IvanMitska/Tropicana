          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <div className="bg-white/10 backdrop-blur-sm border border-white/20 text-white/50 px-6 py-3 rounded-lg text-center transition-all duration-300 font-medium text-sm sm:text-base opacity-50 cursor-not-allowed" title="Бронирование - скоро будет доступно">
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-primary">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <div 
              className="bg-white/50 text-primary/60 px-6 sm:px-8 py-3 sm:py-4 rounded-lg transition-all duration-300 font-medium inline-flex items-center justify-center gap-2 text-sm sm:text-base opacity-50 cursor-not-allowed"
