...
export default function OfficeInfo({ onSelectOffice }: OfficeInfoProps) {
    ...
    <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      <div className="space-y-6">
        {offices.map((office) => (
          ...
          >
            <h3 className="text-xl font-medium mb-3">{office.name}</h3>
