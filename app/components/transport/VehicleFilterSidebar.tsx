  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4">
            ...
            <button
              ...
              className={`flex items-center justify-start p-2 rounded-md border text-sm ${
                localFilters.type === type
                  ? 'bg-dark-light/10 border-dark text-dark'
      ...
      <button
        ...
        className="w-full py-2.5 px-4 bg-dark text-white rounded-md hover:bg-dark-light transition-colors flex items-center justify-center"
        disabled={isLoading}
      >
        {isLoading ? (
