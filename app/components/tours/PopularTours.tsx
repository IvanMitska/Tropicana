  ...
  const tours = [
    {
      ...
      description: 'Увлекательное путешествие на знаменитые острова с кристально чистой водой и белоснежными пляжами.',
      price: 3500,
      priceUnit: '฿/чел',
      location: 'Пхукет, отправление из Чалонг Пирс',
      duration: '8 часов',
      groupSize: '10-15 человек',
      imageSrc: 'https://images.pexels.com/photos/1450353/pexels-photo-1450353.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    ...
    {
      id: 2,
      title: 'Большой Будда и обзорная экскурсия',
      description: 'Посещение знаковых культурных и религиозных достопримечательностей Пхукета с панорамными видами.',
      price: 2200,
      priceUnit: '฿/чел',
      location: 'Пхукет, самые интересные локации',
      duration: '6 часов',
      groupSize: '6-10 человек',
      imageSrc: 'https://images.pexels.com/photos/5458388/pexels-photo-5458388.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    ...
    {
      id: 3,
      title: 'Джунгли и водопады Пхукета',
      ...
      imageSrc: 'https://images.pexels.com/photos/2440024/pexels-photo-2440024.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    ...
    {
      id: 4,
      title: 'Рафтинг и зиплайн в джунглях',
      ...
      imageSrc: 'https://images.pexels.com/photos/1732278/pexels-photo-1732278.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
      type: 'Активный отдых',
      isPopular: false,
      rating: 4.9,
    },
    {
      id: 5,
      title: 'Симиланские острова на скоростном катере',
      description: 'Однодневная экскурсия на знаменитые Симиланские острова с невероятным снорклингом.',
      price: 4500,
      priceUnit: '฿/чел',
      location: 'Пхукет, отправление из Тап-Ламу',
      duration: '10 часов',
      groupSize: '15-20 человек',
      imageSrc: 'https://images.pexels.com/photos/1268866/pexels-photo-1268866.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
      type: 'Морские экскурсии',
      isPopular: true,
      rating: 4.8,
    },
    {
      id: 6,
      title: 'Тайская кухня: кулинарный мастер-класс',
      description: 'Погрузитесь в мир тайской кухни и научитесь готовить традиционные блюда под руководством шеф-повара.',
      price: 1800,
      priceUnit: '฿/чел',
      location: 'Пхукет, Патонг',
      duration: '4 часа',
      groupSize: '4-8 человек',
      imageSrc: 'https://images.pexels.com/photos/5907911/pexels-photo-5907911.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
